...
class CancerCell(Agent):
    ...
    def _spawn_daughter(self, subtype, x, y):
        ...
        # Daughter inherits the same PDL1 expressions as parent
...
class CD8TCell(Agent):
    ...
    def __init__(self, unique_id, model, pos):
        ...
        # 3) Track exhaustion
        self.pd1             = P.PD1_baseline   # surface PD-1 level [0–1]
        self.exhaustion_signal = 0.0            # cumulative PD-1 signaling received
        self.exhaustion_level  = 0.0            # functional exhaustion [0–1]
